...
plt.plot(x_values,  f(x_values), color = "darkblue", linewidth=1.5)
plt.grid()
plt.show()
```

***Primera derivada:*** $f'(x)= 2e^{2x} + 2sin(2x)$*. Aproximaciones con dos tamaños de paso* $h=0.05$ *y* $h=0.25$
...
**Segunda derivada:** $f''(x)= 4e^{x} + 4cos(2x)$. *Aproximaciones con* $h=0.05$ y $h=0.25$
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_25(x_values)), mode='lines', name='h=0.25', line=dict(color='royalblue', width=1)))
...
***Primera derivada:*** $f'(x)= -2x+\frac{1}{x+2}-2$*. Aproximaciones con dos tamaños de paso* $h=0.25$ *y* $h=0.1$
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_25(x_values)), mode='lines', name='h=0.25', line=dict(color='teal', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-derivative(f, x_values).df), mode='lines', name='SciPy', line=dict(color='aqua', width=2)))
...
fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= ddf_1(x_values), mode='lines', name='h=0.1', line=dict(color='royalblue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= ddf_25(x_values), mode='lines', name='h=0.25', line=dict(color='teal', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= dderf(x_values), mode='lines', name='2da. derivada', line=dict(color='goldenrod', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_25(x_values)), mode='lines', name='h=0.25', line=dict(color='teal', width=1)))
...
***Primera derivada:*** $f'(x)= 2x\sqrt{x}\,cos(x^2)+\frac{sen(x^2)}{2\sqrt{x}}$*. Aproximaciones con dos tamaños de paso* $h=0.05$ *y* $h=0.1$
...
x_values = np.linspace(0, np.pi/2, 400)
...
**Primera derivada:** $f'(x)= -3sin(6x)-e^{2x}2$. Aproximaciones con dos tamaños de paso $h=0.05$ y $h=0.125$
...
plt.figure(figsize=(8,6))
plt.plot(x_values,f(x_values), label="Función", color="purple")
plt.fill_between(np.linspace(a,b, 100), y1=0, y2=f(np.linspace(a,b, 100)), color="blue", alpha=0.5)
plt.grid()
plt.legend()
plt.show()
```
...
plt.plot(x[puntos_in_positivo], y[puntos_in_positivo], 'o', color="aqua", label= "Puntos in +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_in_negativo], y[puntos_in_negativo], 'o', color="green", label= "Puntos in -", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_positivo], y[puntos_out_positivo], 'o', color="pink", label= "Puntos out +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_negativo], y[puntos_out_negativo], 'o', color="yellow", label= "Puntos out -", alpha=0.5, markersize=2.5)
plt.plot(x_values,f(x_values), color= "purple", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
plt.show()
```
...
plt.figure(figsize=(8,6))
plt.plot(x[puntos_in], y[puntos_in], 'o', color="purple", label= "Puntos in", alpha=0.5)
...
plt.figure(figsize=(8,6))
plt.plot(x[puntos_in], y[puntos_in], 'o', color="pink", label= "Puntos in", alpha=0.5)
plt.plot(x[~puntos_in], y[~puntos_in], 'o', color="purple", label= "Puntos out", alpha=0.5)
plt.plot(x_values,f(x_values), color= "blue", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
plt.axis('square')
plt.show()
...
plt.figure(figsize=(8,6))
plt.plot(x[puntos_in], y[puntos_in], 'o', color="pink", label= "Puntos in", alpha=0.5)
plt.plot(x[~puntos_in], y[~puntos_in], 'o', color="aqua", label= "Puntos out", alpha=0.5)
plt.plot(x_values,f(x_values), color= "darkblue", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
plt.show()
```
...
plt.figure(figsize=(8,6))
plt.plot(x[puntos_in], y[puntos_in], 'o', color="purple", label= "Puntos in", alpha=0.5)
plt.plot(x[~puntos_in], y[~puntos_in], 'o', color="pink", label= "Puntos out", alpha=0.5)
plt.plot(x_values,f(x_values), color= "blue", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
plt.show()
...
plt.fill_between(x_val, y1=y_val1, y2=y_val2, color="pink", alpha=0.5)
...
plt.plot(x_val, y_val1)
plt.plot(x_val, y_val2)
plt.fill_between(x_val, y1=y_val1, y2=y_val2, color="aqua", alpha=0.5)
plt.title("Región de Integración")
plt.grid()
plt.show()
```
...
plt.plot(x_val, y_val1)
plt.plot(x_val, y_val2)
plt.fill_between(x_val, y1=y_val1, y2=y_val2, color="blue", alpha=0.5)
plt.title("Región de Integración")
plt.grid()
plt.show()
```
...
plt.plot(x_val, y_val1)
plt.plot(x_val, y_val2)
plt.fill_between(x_val, y1=y_val1, y2=y_val2, color="purple", alpha=0.5)
plt.grid()
plt.show()
```
...
for x in x_val: 
  ...
  plt.fill_between(y, 0, y, color="orange", alpha=0.5)
...
plt.figure(figsize=(8,6))
plt.plot(x_values, gamma.pdf(x_values, a), label="Función de densidad")
plt.fill_between(np.linspace(a1,b1, 500), y1=0, y2=gamma.pdf(np.linspace(a1,b1, 500), a), color="blue", alpha=0.5)
plt.grid()
plt.legend()
plt.show()
...
plt.figure(figsize=(8,6))
plt.plot(x_values, beta.pdf(x_values, a, b), label="Función de Densidad Beta", color="pink")
plt.grid()
plt.legend()
...
plt.figure(figsize=(8,6))
plt.plot(x_values, beta.pdf(x_values, a, b), label="Función de Densidad Beta", color="blue")
plt.fill_between(x_fill, 0, beta.pdf(x_fill, a, b), color="aqua", alpha=0.5)
